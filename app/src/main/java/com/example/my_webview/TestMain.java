...
import com.example.my_webview.x5.BrowserActivity;
import com.example.my_webview.x5.FilechooserActivity;
...
public class TestMain extends Activity {
    ...
    private void new_init() {
        ...
        int[] iconResourse = {R.drawable.fullscreen};
        ...
        if (null != this.gridView) {
            ...
            this.gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> gridView, View view,
                    ...
                    switch (position) {
                        case FILE_CHOOSER: {
                            intent = new Intent(TestMain.this,
